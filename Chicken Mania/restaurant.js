...
var listView = function (id, name, image, rating, pricerange) {
  return `<div class="col-sm-3">
    <div class="card mb-4 box-shadow">
      <a href="index.html?id=${id}"><img class="card-img-top" src="${image}"></a>
      <div class="card-body">
...
var getDataForList = function () {
  ...
  $.getJSON(`https://api.airtable.com/v0/appzuVq4QVRYlpDfV/Chicken%20Places?api_key=${api_key}`, function (data) {
...
var detailView = function (id, name, pictureUrl, pricerange, description, website, rating, address, number) {
...
var getDataForId = function (id) {
  $.getJSON(`https://api.airtable.com/v0/appzuVq4QVRYlpDfV/Chicken%20Places/${id}?api_key=${api_key}`, function (record) {
    // console.log(data);
    var html = [];
    html.push(`<div class="row">`);
    // console.log(val)
    ...
    var itemHTML = detailView(id, name, pictureUrl, address, rating, description, website, pricerange, number);
    html.push(itemHTML);
    html.push(`</div>`);
