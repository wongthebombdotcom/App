...
var getParameterByName = function(name, url) {
  ...
  var listView = function(id, name, image, rating) {
    return `
      <div class="card col-sm-4">
        ...
        <div class="card-body">
          ...
          <a href="restaurant.html?id=${id}" class="btn btn-primary" id="button">Eat Now!</a>
        </div>
      </div>`;
  }
  ...
  var getDataForList = function() {
    ...
    $.getJSON(`https://api.airtable.com/v0/appzuVq4QVRYlpDfV/Chicken%20Places?api_key=key87Kh1djUSEKJz9`, function( data ) {
